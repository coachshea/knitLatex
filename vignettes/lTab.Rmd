...
lTab is a command the produces a standard latex table/tabular environment
...
```{r}
lTab(cars, caption.firsthead = 'my caption in firsthead')
```
...
```{r}
lTab(cars, caption.lastfoot = 'my caption in last foot')
```
